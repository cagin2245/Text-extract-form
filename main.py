...
from difflib import SequenceMatcher
    ...
    # --| TODO |---
    # Implement string comparison AND matching once again with better output 
    # Do test with output array of multiple images
    
    # --| FIXME |--
    # textractToArray function doesn't produce an output with correct dictionary form
    # Dictionary output doesn't work the way that expected to work                              
...
if __name__ == "__main__":
    ...
    with open("OutputJSON.txt","w",encoding='utf8')as json_file:   
